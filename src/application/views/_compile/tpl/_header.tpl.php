<?php /* Template_ 2.2.7 2014/09/27 20:13:49 C:\Project\querybuilder\src\application\views\tpl\_header.tpl 000006335 */ 
$TPL_DBS_1=empty($TPL_VAR["DBS"])||!is_array($TPL_VAR["DBS"])?0:count($TPL_VAR["DBS"]);?>
...
<head>
    ...
    <script type="text/javascript" src="/static/js/eqb/eqb-<?php echo $TPL_VAR["PAGE"]?>.js" charset="utf-8"></script>
    <script type="text/javascript" src="/static/js/eqb/eqb-common.js" charset="utf-8"></script>
    
</head>
<body>
<?php echo $TPL_VAR["CSRF_INPUT"]?>
...
<div id="wrap">
    ...
    <div id="container">
            ...
            <div id="sideSelect">
                ...
                <div class="wrap">
                    <div id="sideSelectfakeScroll" class="list">
                        <ul>
                        <!-- <?php if($TPL_DBS_1){foreach($TPL_VAR["DBS"] as $TPL_V1){?> -->
                            <li><a href="javascript:return false;"><?php echo $TPL_V1?></a></li>
                        <!-- <?php }}?> -->
                        </ul>
                    </div>
                    <div class="footer">
        ...
        <div id="content">
            ...
            <script type="text/javascript">
                $('#tap_<?php echo $TPL_VAR["PAGE"]?>').addClass('selected');
            </script>